...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1537480294, '1', './data/template/1_1_common_header_member_switchstatus.tpl.php', './template/default', 'common/header_member_switchstatus')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1537480294, '1', './data/template/1_1_common_header_member_switchstatus.tpl.php', './template/default', 'common/header_member_switchstatus')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1537480294, '1', './data/template/1_1_common_header_member_switchstatus.tpl.php', './template/default', 'common/header_member_switchstatus')
;?>
