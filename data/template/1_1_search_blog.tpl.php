...
0
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/header.htm', 1536802225, '1', './data/template/1_1_search_blog.tpl.php', './template/default', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/pubsearch.htm', 1536802225, '1', './data/template/1_1_search_blog.tpl.php', './template/default', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/blog_list.htm', 1536802225, '1', './data/template/1_1_search_blog.tpl.php', './template/default', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/footer.htm', 1536802225, '1', './data/template/1_1_search_blog.tpl.php', './template/default', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/default/common/header_common.htm', 1536802225, '1', './data/template/1_1_search_blog.tpl.php', './template/default', 'search/blog')
;?>
