...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1537427028, '1', './data/template/1_1_common_header_search_album.tpl.php', './template/default', 'common/header_search_album')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1537427028, '1', './data/template/1_1_common_header_search_album.tpl.php', './template/default', 'common/header_search_album')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1537427028, '1', './data/template/1_1_common_header_search_album.tpl.php', './template/default', 'common/header_search_album')
;?>
