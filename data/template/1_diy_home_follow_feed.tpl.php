...
0
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/userabout.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_header.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/seditor.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/upload.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/seccheck.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/follow_feed_li.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_userabout.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/header_common.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_diy.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_header_personalnv.htm', 1536570344, 'diy', './data/template/1_diy_home_follow_feed.tpl.php', './template/default', 'home/follow_feed')
;?>
...
<!-- template/default/common/header_common -->
...
<!-- <base href="<?php echo $_G['config']['output']['staticdomain'];?>" /> --><link rel="stylesheet" type="text/css" href="https://static.baobeihuijia.com/data/cache/style_1_common.css?<?php echo VERHASH;?>" /><link rel="stylesheet" type="text/css" href="https://static.baobeihuijia.com/data/cache/style_1_home_follow.css?<?php echo VERHASH;?>" /><?php if($_G['uid'] && isset($_G['cookie']['extstyle']) && strpos($_G['cookie']['extstyle'], TPLDIR) !== false) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['cookie']['extstyle'];?>/style.css?1" /><?php } elseif($_G['style']['defaultextstyle']) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['config']['output']['staticdomain'].$_G['style']['defaultextstyle'];?>/style.css?2" /><?php } ?><script type="text/javascript">var STYLEID = '<?php echo STYLEID;?>', STATICURL = '<?php echo STATICURL;?>', IMGDIR = '<?php echo IMGDIR;?>', VERHASH = '<?php echo VERHASH;?>', charset = '<?php echo CHARSET;?>', discuz_uid = '<?php echo $_G['uid'];?>', cookiepre = '<?php echo $_G['config']['cookie']['cookiepre'];?>', cookiedomain = '<?php echo $_G['config']['cookie']['cookiedomain'];?>', cookiepath = '<?php echo $_G['config']['cookie']['cookiepath'];?>', showusercard = '<?php echo $_G['setting']['showusercard'];?>', attackevasive = '<?php echo $_G['config']['security']['attackevasive'];?>', disallowfloat = '<?php echo $_G['setting']['disallowfloat'];?>', creditnotice = '<?php if($_G['setting']['creditnotice']) { ?><?php echo $_G['setting']['creditnames'];?><?php } ?>', defaultstyle = '<?php echo $_G['style']['defaultextstyle'];?>', REPORTURL = '<?php echo $_G['currenturl_encode'];?>', SITEURL = '<?php echo $_G['siteurl'];?>', JSPATH = '<?php echo $_G['setting']['jspath'];?>', CSSPATH = '<?php echo $_G['setting']['csspath'];?>', DYNAMICURL = '<?php echo $_G['dynamicurl'];?>';</script>
