...
0
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_extra.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_body.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_attribute.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/seccheck_post.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor_menu.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/editor_menu_forum.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/upload.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/seccheck.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1536569049, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
...
<span><input type="text" name="subject" id="subject" class="px" value="<?php echo $postinfo['subject'];?>" onkeyup="strLenCalc(this, 'checklen', 120);" style="width: 25em" tabindex="1" /></span>
<?php } else { ?>
...
<?php } ?>			
<span id="subjectchk"<?php if($_GET['action'] == 'reply') { ?> style="display:none"<?php } ?>>还可输入 <strong id="checklen">120</strong> 个字符</span>
