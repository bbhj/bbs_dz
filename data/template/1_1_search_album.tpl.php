<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('album');
0
|| checktplrefresh('./template/default/search/album.htm', './template/default/search/header.htm', 1537262621, '1', './data/template/1_1_search_album.tpl.php', './template/default', 'search/album')
|| checktplrefresh('./template/default/search/album.htm', './template/default/search/pubsearch.htm', 1537262621, '1', './data/template/1_1_search_album.tpl.php', './template/default', 'search/album')
|| checktplrefresh('./template/default/search/album.htm', './template/default/search/album_list.htm', 1537262621, '1', './data/template/1_1_search_album.tpl.php', './template/default', 'search/album')
|| checktplrefresh('./template/default/search/album.htm', './template/default/search/footer.htm', 1537262621, '1', './data/template/1_1_search_album.tpl.php', './template/default', 'search/album')
|| checktplrefresh('./template/default/search/album.htm', './template/default/common/header_common.htm', 1537262621, '1', './data/template/1_1_search_album.tpl.php', './template/default', 'search/album')
;?>
...
<?php } ?><?php if(!empty($_G['setting']['pluginhooks']['album_top'])) echo $_G['setting']['pluginhooks']['album_top'];?>
...
</div><?php echo adshow("search/y mtw");?><?php if(empty($albumlist)) { ?>
<p class="emp xs2 xg2">对不起，没有找到匹配结果。</p>
<?php } else { ?>
<div class="slst xld xlda mtw">
<ul class="ml mla cl"><?php if(is_array($albumlist)) foreach($albumlist as $key => $value) { ?><li>
<div class="c"><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>&amp;do=album&amp;id=<?php echo $value['albumid'];?>" target="_blank"><?php if($value['pic']) { ?><img src="<?php echo $value['pic'];?>" /><?php } ?></a></div>
<p class="ptm"><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>&amp;do=album&amp;id=<?php echo $value['albumid'];?>" target="_blank"><?php echo $value['albumname'];?></a></p>
</li>
<?php } ?>
</ul>
</div>
...
<?php if(!empty($_G['setting']['pluginhooks']['album_bottom'])) echo $_G['setting']['pluginhooks']['album_bottom'];?><?php $focusid = getfocus_rand($_G[basescript]);?><?php if($focusid !== null) { $focus = $_G['cache']['focus']['data'][$focusid];?><div class="focus" id="focus">
<div class="bm">
<div class="bm_h cl">
