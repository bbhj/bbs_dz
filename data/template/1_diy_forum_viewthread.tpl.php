...
0
|| checktplrefresh('data/diy/./template/default//forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1536568905, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', 'data/diy/./template/default/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/default//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1536568905, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', 'data/diy/./template/default/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/default//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1536568905, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', 'data/diy/./template/default/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/default//forum/viewthread.htm', './template/default/common/seditor.htm', 1536568905, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', 'data/diy/./template/default/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/default//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1536568905, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', 'data/diy/./template/default/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/default//forum/viewthread.htm', './template/default/common/upload.htm', 1536568905, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', 'data/diy/./template/default/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/default//forum/viewthread.htm', './template/default/common/seccheck.htm', 1536568905, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', 'data/diy/./template/default/', 'forum/viewthread')
...
<?php } ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>" onclick="return copyThreadUrl(this, '<?php echo $_G['setting']['bbname'];?>')" <?php if($fromuid) { ?>title="您的朋友访问此链接后，您将获得相应的积分奖励"<?php } ?>>[复制链接]</a>
</span>
